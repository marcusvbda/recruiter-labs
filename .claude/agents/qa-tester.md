...
stated once in `CLAUDE.md` → Testing. Never add a test to "prove" your own diagnosis, and never propose
...
Never delete tests. Global rules in `CLAUDE.md` apply in full.
