...
return [
    ...
    'fields' => ['recipient' => 'Destinatario', 'subject' => 'Asunto', 'body' => 'Mensaje', 'language' => 'Idioma del borrador'],
    'composer' => ['heading' => 'Contactar a :candidate', 'job_context' => 'Este mensaje trata sobre :job.', 'provider_unavailable' => 'El envío no está disponible hasta que se configure el proveedor de correo del espacio de trabajo. Aún puedes revisar y editar este borrador.'],
    'history' => [
        'heading' => 'Comunicación', 'description' => 'Mensajes de Recruiter Labs enviados a este candidato, agrupados por vacante.', 'context_description' => 'Mensajes de Recruiter Labs enviados a este candidato sobre :job.', 'application_description' => 'Mensajes enviados por Recruiter Labs para este candidato y vacante.', 'empty' => 'Todavía no se ha registrado ninguna comunicación.', 'empty_for_application' => 'Todavía no se ha registrado ninguna comunicación para esta candidatura.', 'untitled_draft' => 'Borrador sin título', 'ai_assisted' => 'Con asistencia de IA', 'manual' => 'Manual', 'authorized_by' => 'Autorizado por :name', 'direction' => ':sender para :recipient',
    ],
