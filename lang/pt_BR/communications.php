...
return [
    ...
    'fields' => ['recipient' => 'Destinatário', 'subject' => 'Assunto', 'body' => 'Mensagem', 'language' => 'Idioma do rascunho'],
    'composer' => ['heading' => 'Contatar :candidate', 'job_context' => 'Esta mensagem é sobre :job.', 'provider_unavailable' => 'O envio não está disponível até que o provedor de e-mail do workspace seja configurado. Você ainda pode revisar e editar este rascunho.'],
    'history' => [
        'heading' => 'Comunicação', 'description' => 'Mensagens do Recruiter Labs enviadas a este candidato, agrupadas por vaga.', 'context_description' => 'Mensagens do Recruiter Labs enviadas a este candidato sobre :job.', 'application_description' => 'Mensagens enviadas pelo Recruiter Labs para este candidato e vaga.', 'empty' => 'Nenhuma comunicação foi registrada ainda.', 'empty_for_application' => 'Nenhuma comunicação foi registrada para esta candidatura ainda.', 'untitled_draft' => 'Rascunho sem título', 'ai_assisted' => 'Com assistência de IA', 'manual' => 'Manual', 'authorized_by' => 'Autorizado por :name', 'direction' => ':sender para :recipient',
    ],
